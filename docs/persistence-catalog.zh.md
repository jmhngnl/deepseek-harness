...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`packages/medical/medical-case/src/domain.ts#MedicalCaseChangeMeta`](#persistence-type-packagesmedicalmedical-casesrcdomaintsmedicalcasechangemeta) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"medical/case-change"` |
...
来源：[`packages/medical/medical-case/src/domain.ts:17`](../packages/medical/medical-case/src/domain.ts) · [`packages/medical/medical-case/src/domain.ts:29`](../packages/medical/medical-case/src/domain.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `case` | 必需 | [`packages/medical/medical-case/src/types.ts#CaseState`](#persistence-type-packagesmedicalmedical-casesrctypestscasestate) |
| `kind` | 必需 | `"medical/case-change"` |
| `operation` | 必需 | [`packages/medical/medical-case/src/types.ts#CaseOperation`](#persistence-type-packagesmedicalmedical-casesrctypestscaseoperation) |
| `version` | 必需 | `1` |
...
来源：[`packages/medical/medical-case/src/types.ts:32`](../packages/medical/medical-case/src/types.ts)
...
来源：[`packages/medical/medical-case/src/types.ts:39`](../packages/medical/medical-case/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `additionalNotes` | 必需 | [`event:medical/case-change.data.case.additionalNotes`](#persistence-type-eventmedicalcase-changedatacaseadditionalnotes) |
| `age` | 必需 | [`event:compaction/end.data.turn`](#persistence-type-eventcompactionenddataturn) |
| `caseId` | 必需 | `string` |
| `createdAt` | 必需 | `number` |
| `duration` | 必需 | [`event:medical/case-change.data.case.additionalNotes`](#persistence-type-eventmedicalcase-changedatacaseadditionalnotes) |
| `revision` | 必需 | `number` |

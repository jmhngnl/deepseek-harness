...
- `@deepseek-ai/dsh-medical-case` — requires `agents` · `sessionProjections` ([`packages/medical/medical-case/src/index.ts`](../packages/medical/medical-case/src/index.ts))
...
- `@deepseek-ai/dsh-tool-medical-case-get` — requires `agents` · `medicalCase` · `tools` ([`packages/medical/tool-medical-case-get/src/index.ts`](../packages/medical/tool-medical-case-get/src/index.ts))
- `@deepseek-ai/dsh-tool-medical-case-intake` — requires `agents` · `medicalCase` · `tools` ([`packages/medical/tool-medical-case-intake/src/index.ts`](../packages/medical/tool-medical-case-intake/src/index.ts))
- `@deepseek-ai/dsh-tool-medical-case-update` — requires `agents` · `medicalCase` · `tools` ([`packages/medical/tool-medical-case-update/src/index.ts`](../packages/medical/tool-medical-case-update/src/index.ts))
